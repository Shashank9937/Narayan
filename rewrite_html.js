...
// 1. Remove the old site-header entirely
html = html.replace(/<header class="site-header">[\s\S]*?<\/header>/, '');

// 2. Replace the nav sectionNav block with the new sidebar
const navRegex = /<nav class="section-nav" id="sectionNav">([\s\S]*?)<\/nav>/;
const sidebarHTML = `
  <div class="app-layout">
    <aside class="sidebar" id="sidebar">
      <div class="sidebar-header">
        <a href="#" class="brand-wrap">
          <img src="/logo.svg" alt="Narayan" class="brand-logo" />
      ...
      <nav class="section-nav" id="sectionNav">
        <button class="nav-btn active" data-target="overviewSection">
        ...
        <button class="nav-btn" data-target="employeeSection">
        ...
        <button class="nav-btn" data-target="attendanceSection">
        ...
        <button class="nav-btn" data-target="salarySection">
        ...
        <button class="nav-btn" data-target="truckSection">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="1" y="3" width="15" height="13"></rect><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"></polygon><circle cx="5.5" cy="18.5" r="2.5"></circle><circle cx="18.5" cy="18.5" r="2.5"></circle></svg>
          Trucks
        </button>
        <button class="nav-btn" data-target="expenseSection">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="2" x2="12" y2="22"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>
          Expenses
        </button>
        <button class="nav-btn" data-target="investmentSection">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="2" x2="12" y2="22"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>
          Investments
        </button>
        <button class="nav-btn" data-target="chiniSection">
        ...
        <button class="nav-btn" data-target="landSection">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3h18v18H3z"></path><path d="M12 8v8"></path><path d="M8 12h8"></path></svg>
          Land
        </button>
        <button class="nav-btn" data-target="vehicleSection">
        ...
        <button class="nav-btn" data-target="supplierSection">
        ...
        <button class="nav-btn" data-target="billingSection">
          <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
          Billing
        </button>
        <button class="nav-btn" data-target="settingsSection">
      ...
      <div class="sidebar-footer">
        <button id="darkModeToggle" class="theme-toggle" title="Toggle dark mode" aria-label="Toggle dark mode">
        ...
        <div id="sessionBar" class="session-bar hidden">
          <div class="user-info">
            <span id="userMeta" class="user-meta-name"></span>
          </div>
          <button id="logoutBtn" class="small icon-btn danger-text" title="Logout">
      ...
      <header class="content-header">
        ...
        <div class="content-header-actions">
           <div id="lastRefreshedWrap" class="last-refreshed-wrap hidden">
            ...
            <button id="manualRefreshBtn" class="small icon-btn">
...
html = html.replace(navRegex, sidebarHTML);

// 3. We also need to remove the inline #lastRefreshedWrap from overviewSection because we moved it to content-header
html = html.replace(/<div id="lastRefreshedWrap" class="last-refreshed-wrap hidden">[\s\S]*?<\/div>/, '');

// 4. Wrap the end of appContent with our closing div layout tags
html = html.replace(/<\/section>\s*<script src="\/app\.js\?v=2"><\/script>/, `      </div>\n    </main>\n  </div>\n</section>\n<script src="/app.js?v=2"></script>`);
